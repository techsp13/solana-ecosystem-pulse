...
> **Generated at:** `2026-08-31T16:12:48Z` | **Network:** `Solana Mainnet-Beta`  
...
|---|---|---|---|
| **Current Throughput** | **5,596.7 TPS** | ~2,500 - 3,500 TPS | 🟢 Nominal |
| **Average TPS (Recent)** | **5,093.1 TPS** | > 2,000 TPS | 🟢 Nominal |
| **Current Slot Height** | `#443,193,792` | — | 🟢 Synchronized |
| **Epoch Progress** | **Epoch 1025 (91.16%)** | 432,000 slots | 🟢 On Schedule |
| **Slot Execution Time** | **408 ms** | 400 ms target | 🟢 Healthy |
| **Total Processed Txs** | `543,816,242,712` | Cumulative | 🟢 Continuous |
...
|---|---|---|
| **Active Consensus Validators** | **680 nodes** | 🟢 Optimal |
| **Delinquent Validators** | **17 nodes** (2.44%) | 🟢 Low Risk |
| **Total Active Stake** | **437,104,291.28 SOL** | 🟢 Secured |
...
|---|---|---|
| **SOL Price (USD)** | **$102.86** | `-3.47%` |
| **Solana DeFi TVL** | **$5,779,692,866.48** | Robust liquidity |
