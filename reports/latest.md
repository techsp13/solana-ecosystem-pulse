...
> **Generated at:** `2026-09-07T12:09:30Z` | **Network:** `Solana Mainnet-Beta`  
...
|---|---|---|---|
| **Current Throughput** | **3,517.9 TPS** | ~2,500 - 3,500 TPS | 🟢 Nominal |
| **Average TPS (Recent)** | **3,608.6 TPS** | > 2,000 TPS | 🟢 Nominal |
| **Current Slot Height** | `#445,061,722` | — | 🟢 Synchronized |
| **Epoch Progress** | **Epoch 1030 (23.55%)** | 432,000 slots | 🟢 On Schedule |
| **Slot Execution Time** | **408 ms** | 400 ms target | 🟢 Healthy |
| **Total Processed Txs** | `545,997,282,740` | Cumulative | 🟢 Continuous |
...
|---|---|---|
| **Active Consensus Validators** | **674 nodes** | 🟢 Optimal |
| **Delinquent Validators** | **14 nodes** (2.03%) | 🟢 Low Risk |
| **Total Active Stake** | **439,244,119.24 SOL** | 🟢 Secured |
...
|---|---|---|
| **SOL Price (USD)** | **$105.04** | `-1.31%` |
| **Solana DeFi TVL** | **$5,924,761,772.53** | Robust liquidity |
