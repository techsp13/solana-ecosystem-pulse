...
> **Generated at:** `2026-09-20T20:11:36Z` | **Network:** `Solana Mainnet-Beta`  
...
|---|---|---|---|
| **Current Throughput** | **4,660.1 TPS** | ~2,500 - 3,500 TPS | 🟢 Nominal |
| **Average TPS (Recent)** | **4,946.5 TPS** | > 2,000 TPS | 🟢 Nominal |
| **Current Slot Height** | `#448,835,656` | — | 🟢 Synchronized |
| **Epoch Progress** | **Epoch 1038 (97.14%)** | 432,000 slots | 🟢 On Schedule |
| **Slot Execution Time** | **408 ms** | 400 ms target | 🟢 Healthy |
| **Total Processed Txs** | `550,663,989,772` | Cumulative | 🟢 Continuous |
...
|---|---|---|
| **Active Consensus Validators** | **675 nodes** | 🟢 Optimal |
| **Delinquent Validators** | **15 nodes** (2.17%) | 🟢 Low Risk |
| **Total Active Stake** | **439,961,298.80 SOL** | 🟢 Secured |
...
|---|---|---|
| **SOL Price (USD)** | **$110.38** | `-0.63%` |
| **Solana DeFi TVL** | **$6,164,828,069.36** | Robust liquidity |
