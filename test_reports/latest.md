...
> **Generated at:** `2026-08-30T09:04:08Z` | **Network:** `Solana Mainnet-Beta`  
...
|---|---|---|---|
| **Current Throughput** | **3,112.2 TPS** | ~2,500 - 3,500 TPS | 🟢 Nominal |
| **Average TPS (Recent)** | **3,143.8 TPS** | > 2,000 TPS | 🟢 Nominal |
| **Current Slot Height** | `#442,840,485` | — | 🟢 Synchronized |
| **Epoch Progress** | **Epoch 1025 (9.37%)** | 432,000 slots | 🟢 On Schedule |
| **Slot Execution Time** | **408 ms** | 400 ms target | 🟢 Healthy |
| **Total Processed Txs** | `543,370,769,106` | Cumulative | 🟢 Continuous |
...
| **Total Active Stake** | **436,877,423.75 SOL** | 🟢 Secured |
...
|---|---|---|
| **SOL Price (USD)** | **$104.84** | `+1.42%` |
| **Solana DeFi TVL** | **$5,901,472,291.19** | Robust liquidity |
